...
public static class RealtimeServiceCollection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSingleton<IPageRealtimePublisher, SignalRPageRealtimePublisher>();
        ...
        services.AddSingleton<ISocialRealtimePublisher, SignalRSocialRealtimePublisher>();
