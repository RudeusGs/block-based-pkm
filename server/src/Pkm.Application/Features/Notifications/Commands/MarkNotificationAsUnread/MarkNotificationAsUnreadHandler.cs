...
public sealed class MarkNotificationAsUnreadHandler : ICommandHandler<MarkNotificationAsUnreadCommand, NotificationDto>
{
    ...
    public MarkNotificationAsUnreadHandler(
