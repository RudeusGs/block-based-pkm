...
public sealed class TaskCommentUpdatedDomainEventHandler : IDomainEventHandler<TaskCommentUpdatedDomainEvent>
{
    ...
    public TaskCommentUpdatedDomainEventHandler(
    ...
    public async Task HandleAsync(
        TaskCommentUpdatedDomainEvent domainEvent,
        CancellationToken cancellationToken = default)
    {
        ...
        await _activityLogService.RecordAsync(
            new ActivityLogRequest(
                ...
                $"{actorDisplayName} đã cập nhật bình luận trong task \"{taskDetail.Title}\".",
                ActivityLogMetadata.Serialize(new
                {
                    ...
                    oldContentPreview = Preview(domainEvent.OldContent),
                    newContentPreview = Preview(domainEvent.NewContent)
                })),
            cancellationToken);
