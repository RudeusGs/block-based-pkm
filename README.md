...
> Tạo thư mục `docs/demo/` ở root project, sau đó bỏ ảnh demo vào đúng tên file bên dưới. Nếu ảnh của bạn đặt tên khác, chỉ cần sửa lại đường dẫn trong README.
...
![Trang đăng nhập](docs/demo/login-page.png)

![Trang đăng ký](docs/demo/register-page.png)

### 3. Workspace dashboard

![Workspace dashboard](docs/demo/workspace-dashboard.png)

### 4. Workspace tree, Favorite, Recent và Trash

![Workspace tree](docs/demo/workspace-tree.png)

### 5. Page editor dạng block

![Page editor](docs/demo/page-editor.png)

### 6. Task management

![Task management](docs/demo/task-management.png)

### 7. AI Prioritizer

![AI Prioritizer](docs/demo/ai-prioritizer.png)

### 8. Activity log

![Activity log](docs/demo/activity-log.png)

### 9. Social hub và profile cá nhân

![Social hub](docs/demo/social-hub.png)

![User profile](docs/demo/user-profile.png)

### 10. Messenger realtime

![Messenger realtime](docs/demo/messenger.png)

### 11. Workspace members và phân quyền

![Workspace members](docs/demo/workspace-members.png)

### 12. Realtime collaboration

![Realtime collaboration](docs/demo/realtime-collaboration.png)
...
{
  "ConnectionStrings": {
    "Connection": "Host=localhost;Port=5432;Database=your_database_name;Username=your_database_user;Password=your_database_password"
  },
  ...
  "Realtime": {
    ...
    "BlockLeaseTtlSeconds": 30,
    "UseRedisBackplane": true,
    "RedisBackplaneChannelPrefix": "pkm:signalr"
  },

  "App": {
    "PublicBaseUrl": "http://localhost:5173",
    "WorkspaceInvitationAcceptPath": "/success"
  },
