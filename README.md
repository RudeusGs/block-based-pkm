...
**AI Prioritizer** là module gợi ý task thông minh trong hệ thống.
...
Module này không phụ thuộc bắt buộc vào API AI bên ngoài. Hệ thống ưu tiên dùng scoring, rule-based logic và semantic dedupe.
